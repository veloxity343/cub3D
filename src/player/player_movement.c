...
/*   Updated: 2025/04/21 16:50:41 by yyan-bin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	move_player(t_game *game)
{
	...
	if (game->player.move.y == 1)
		moved += move_player_dir(game, game->player.dir_t.x, game->player.dir_t.y);
	if (game->player.move.y == -1)
		moved += move_player_dir(game, -game->player.dir_t.x, -game->player.dir_t.y);
	if (game->player.move.x == -1)
		moved += move_player_dir(game, game->player.dir_t.y, -game->player.dir_t.x);
	if (game->player.move.x == 1)
		moved += move_player_dir(game, -game->player.dir_t.y, game->player.dir_t.x);
